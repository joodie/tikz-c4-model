...
% top of cylinder is an oval of y-radius 1cm
\pgfdeclareshape{c4 person}{
  ...
  \anchor{north} {%
    \northeast%
   \pgf@x=0cm%
    \advance\pgf@y by 2cm%
  }%

  \anchor{north east} {%
    \northeast%
    \advance\pgf@y by 1cm%
  }%
  ...
  \backgroundpath{% this is new
    % store lower right in xa/ya and upper right in xb/yb, width in xc

    \northeast \pgf@xb=\pgf@x \pgf@yb=\pgf@y \pgf@xc=\pgf@x
    \southwest \pgf@xa=\pgf@x \pgf@ya=\pgf@y
    \advance\pgf@yb by 1cm
    \advance\pgf@xc by -\pgf@x
    \pgf@xc = 0.5\pgf@xc
    % construct main path
    \pgfpathmoveto{\pgfpoint{\pgf@xa}{\pgf@ya}}
    \pgfpathlineto{\pgfpoint{\pgf@xa}{\pgf@yb}}
    \pgfpatharc{180}{0}{\pgf@xc and 1 cm}
%    \pgfpathlineto{\pgfpoint{\pgf@xb}{\pgf@yb}}
    \pgfpathlineto{\pgfpoint{\pgf@xb}{\pgf@ya}}
    \pgfpatharc{0}{180}{\pgf@xc and -1 cm}
    \pgfpathclose
  }
}
